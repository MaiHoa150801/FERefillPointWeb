...
const Setting = () => {
    ...
    const { name, email, phone, address, latitude, longitude, description } = shop;
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-8 col-lg-10 col-xl-8 mx-auto">
                            <div>
                                <h2>Privacy Policy of <span className="website_url">https://refill-point.vercel.app/</span></h2>
                                <p>At <span className="website_name">Refill Point</span>, we collect and manage user data according to the following Privacy Policy.</p>
                                ...
                                <p>We only use your personal information to provide you the <span className="website_name">Refill Point</span> services or to communicate with you about the Website or the services.</p>
                        ...
                        <div id="" className="col-4 col-lg-2 col-xl-4 mx-auto">
                            ...
                            <form onSubmit={newShop} encType="multipart/form-data" id="wlg_form" >
                                <div className="row">
                                ...
                                <div className="wizard-steps-body">
                                    <div className="wizard-steps-body-item body-1 active" >
                                        <fieldset className="wlg-form-group">
                                            <div className="wlg-form-control form-group" control_id="website_name">
                                                <label htmlFor="website_name">Tên Cửa hàng</label>
                                                <input className="form-control" type="text" name="name" id="name" value={name} onChange={handleDataChange} />
                                            </div>
                                        </fieldset>
                                        <fieldset className="wlg-form-group">
                                            <div className="wlg-form-control form-group" control_id="website_url">

                                                <label htmlFor="website_url">Email</label>
                                                <input className="form-control" type="email" name="email" id="email" placeholder="Enter..." value={email} onChange={handleDataChange} />
                                            </div>
                                        </fieldset>
                                        <fieldset className="wlg-form-group">
                                            <div className="wlg-form-control form-group" control_id="website_url">
                                                ...
                                                <input className="form-control" type="number" name="phone" id="phone" placeholder="Enter..." value={phone} onChange={handleDataChange} />
                                            </div>
                                        </fieldset>
                                        <fieldset className="wlg-form-group">
                                            <div className="wlg-form-control form-group" control_id="country">
                                                <label htmlFor="website_name">Địa chỉ</label>
                                                <input className="form-control" type="text" name="address" id="address" placeholder="Enter..." value={address} onChange={handleDataChange} />
                                            </div>
                                        </fieldset>
                                        <div>
                                            <fieldset className="row">
                                                <label htmlFor="address">Xem trên google để biết chính xác địa chỉ của shop bạn.</label>
                                                <div className="form-group col-6" control_id="country">
                                                    <label htmlFor="website_name">Kinh độ</label>
                                                    <input className="form-control" type="number" name="latitude" id="latitude" placeholder="Enter..." value={latitude} onChange={handleDataChange} />
                                                </div>
                                                <div className="form-group col-6" control_id="country">
                                                    <label htmlFor="website_name">Vĩ độ</label>
                                                    <input className="form-control" type="number" name="longitude" id="longitude" placeholder="Enter..." value={longitude} onChange={handleDataChange} />
                                                </div>
                                            </fieldset>
                                        </div>
                                        <fieldset className="wlg-form-group">
                                            <div className="wlg-form-control form-group" control_id="email_address">
                                                <label htmlFor="email_address">Mô tả</label>
                                                <textarea className="form-control" type="text" name="description" id="description" placeholder="Enter..." value={description} onChange={handleDataChange} />
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
                                <FormControlLabel control={<Checkbox />} label="Agree with Privacy Policy of the website" />
                                <div className="wizard-steps-navigation">
                                    <button className="btn btn-primary active" type="submit" id="wlg_submit">Bán hàng</button>
                                </div>
                            </form>
