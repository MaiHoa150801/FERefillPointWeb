...
import AddLogo from "../../assets/svg/logo.png";

function SvgComponent(props) {
  return (
    // <svg xmlns="./logo.svg" width={27} height={40} viewBox="0 0 27 40" {...props}>
    ...
    //     <rect data-name="Rectangle 15" width={20} height={8} rx={4} transform="translate(382 37)" fill="#1f78c7" />
    //     <rect data-name="Rectangle 12" width={8} height={8} rx={4} transform="translate(375 29)" fill="#4cd5c5" />
    //   </g>
    // </svg>
    <img src={AddLogo} alt='logo' width={40} height={40} ></img>
  );
}
